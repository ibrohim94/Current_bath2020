...
import Resuable_Classes.Abstract_class_Parameter;
...
public class kayak_Data_Driven_TestNG_Abstruct_CrossBrowser extends Abstract_class_Parameter {
    ...
    public void kayakSearch() throws InterruptedException, WriteException, IOException, BiffException {
        ...
        for (int i = 1; i < 2; i++) {
            ...
            Reusable_Classes_logger.click(driver, "//*[@class='item-info']", "Clicking outside", logger);
